...
- 사진 1에서의 빨간색 네모 친 부분을 통해 의약품의 종류를 일반 , 마약 , 폭발물 , 생물학적제제로 분류하기로 결정
- 사진 2에서의 빨간색 네모 친 부분을 통해 의약품 보관 온도를 상온 , 냉동 , 냉장으로 분류하기로 결정

- 결과적으로 **의약품의 종류는 마약 및 항정 , 폭발물 , 생물학적제제 , 일반**으로 구분되고, **의약품의 보관 온도는 상온 , 냉동 , 냉장**으로 구분됨
- **<span style="color:red">즉 의약품 테이블은 필수적으로 의약품 종류 필드와 보관 온도 필드를 갖는데 이미 값이 정해져있으므로 enum으로 설계하고자 함</span>**
